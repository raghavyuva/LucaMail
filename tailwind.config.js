module.exports = {
  ...
  theme: {
    colors: {
      ...
      SupportCardBackground: "var(--background-SupportCardBackground)",
      SupportCardText: "var(--color-SupportCardText)",
      SupportCardButtonBackground:
        "var(--background-SupportCardButtonBackground)",
      SupportCardButtonText: "var(--color-SupportCardButtonText)",
      SupportCardTitle: "var(--color-SupportCardTitle)",
